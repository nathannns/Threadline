...
// Julia-inspired analog chorus/vibrato. Matches the real Walrus Audio
// Julia's exact control surface — Rate, Depth, Lag (the LFO's center delay
// time), a Sine/Triangle waveform switch, and D-C-V (Dry-Chorus-Vibrato) —
// rather than the wider knob set (Width/Tone/Flanger modes) an earlier,
// Dimension-D-inspired version of this module had.
//
